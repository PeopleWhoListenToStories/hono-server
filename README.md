# Hono Gpt Api Server 基于 Hono 的快速开发模板
...
访问 <http://localhost:4321> 查看 API 文档。
...
// 前端运行：npx openapi-typescript http://localhost:4321/admin/doc
...
# 运行容器
docker run -p 4321:4321 --env-file .env clhoria-template
```
